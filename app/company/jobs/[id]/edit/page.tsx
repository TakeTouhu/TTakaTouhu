  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/company/jobs" className="text-gray-500 hover:text-gray-700 text-sm">← 戻る</Link>
        <h1 className="text-2xl font-bold text-gray-900">案件を編集する</h1>
      </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button type="button" onClick={addSkill}
                className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm hover:bg-gray-200">追加</button>
            </div>
